...
const DICE_IMAGES = {
  orange : [diceOrange01, diceOrange02, diceOrange03, diceOrange04, diceOrange05, diceOrange06],
  green : [diceGreen01, diceGreen02, diceGreen03, diceGreen04, diceGreen05, diceGreen06]
}

function Dice ({ color = 'orange', num = 1 }) {
